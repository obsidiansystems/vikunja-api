...
data Order = Order
  ...
  , orderStatus :: !(Maybe E'Status2) -- ^ "status" - Order Status
...
data Pet = Pet
  ...
  , petStatus :: !(Maybe E'Status) -- ^ "status" - pet status in the store
  } deriving (P.Show, P.Eq, P.Typeable)
...
toE'Status = \case
  "available" -> P.Right E'Status'Available
  "pending" -> P.Right E'Status'Pending
  "sold" -> P.Right E'Status'Sold
...
data E'Status2
  ...
  | E'Status2'Approved -- ^ @"approved"@
  | E'Status2'Delivered -- ^ @"delivered"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)
...
toE'Status2 = \case
  ...
  "approved" -> P.Right E'Status2'Approved
  "delivered" -> P.Right E'Status2'Delivered
