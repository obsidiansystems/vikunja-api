...
-- | 
data PetStoreConfig = PetStoreConfig
...
-- | display the config
instance P.Show PetStoreConfig where
  show c =
    T.printf
...
-- | constructs a default PetStoreConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"petstore-client/1.0.5"@
--
newConfig :: IO PetStoreConfig
newConfig = do
    logCxt <- initLogContext
    return $ PetStoreConfig
        { configHost = "https://petstore.swagger.io/v2"
        , configUserAgent = "petstore-client/1.0.5"
...
addAuthMethod :: AuthMethod auth => PetStoreConfig -> auth -> PetStoreConfig
addAuthMethod config@PetStoreConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: PetStoreConfig -> IO PetStoreConfig
...
withStderrLogging :: PetStoreConfig -> IO PetStoreConfig
...
withNoLogging :: PetStoreConfig -> PetStoreConfig
...
data PetStoreRequest req contentType res accept = PetStoreRequest
  { rMethod  :: NH.Method   -- ^ Method of PetStoreRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of PetStoreRequest
  , rParams   :: Params -- ^ params of PetStoreRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (PetStoreRequest req contentType res accept) NH.Method
rMethodL f PetStoreRequest{..} = (\rMethod -> PetStoreRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (PetStoreRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f PetStoreRequest{..} = (\rUrlPath -> PetStoreRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (PetStoreRequest req contentType res accept) Params
rParamsL f PetStoreRequest{..} = (\rParams -> PetStoreRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (PetStoreRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f PetStoreRequest{..} = (\rAuthTypes -> PetStoreRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => PetStoreRequest req contentType res accept -> param -> PetStoreRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: PetStoreRequest req contentType res accept -> param -> PetStoreRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: PetStoreRequest req contentType res accept -> param -> PetStoreRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** PetStoreRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> PetStoreRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = PetStoreRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: PetStoreRequest req contentType res accept -> [NH.Header] -> PetStoreRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: PetStoreRequest req contentType res accept -> [NH.HeaderName] -> PetStoreRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => PetStoreRequest req contentType res accept -> PetStoreRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => PetStoreRequest req contentType res accept -> PetStoreRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: PetStoreRequest req contentType res accept -> [NH.QueryItem] -> PetStoreRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: PetStoreRequest req contentType res accept -> WH.Form -> PetStoreRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: PetStoreRequest req contentType res accept -> NH.Part -> PetStoreRequest req contentType res accept
...
_setBodyBS :: PetStoreRequest req contentType res accept -> B.ByteString -> PetStoreRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: PetStoreRequest req contentType res accept -> BL.ByteString -> PetStoreRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => PetStoreRequest req contentType res accept -> P.Proxy authMethod -> PetStoreRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: PetStoreConfig
    -> a
    -> PetStoreRequest req contentType res accept
    -> IO (PetStoreRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> PetStoreConfig
  -> IO (PetStoreRequest req contentType res accept)
_applyAuthMethods req config@(PetStoreConfig {configAuthMethods = as}) =
  foldlM go req as
  where
