...
addPet 
  ...
  -> PetStoreRequest AddPet contentType NoContent MimeNoContent
addPet _ body =
  _mkRequest "POST" ["/pet"]
...
deletePet 
  ...
  -> PetStoreRequest DeletePet MimeNoContent NoContent MimeNoContent
...
findPetsByStatus 
  ...
  -> PetStoreRequest FindPetsByStatus MimeNoContent [Pet] accept
...
findPetsByTags 
  ...
  -> PetStoreRequest FindPetsByTags MimeNoContent [Pet] accept
...
getPetById 
  ...
  -> PetStoreRequest GetPetById MimeNoContent Pet accept
...
updatePet 
  ...
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Pet -- ^ "body" -  Pet object that needs to be added to the store
  -> PetStoreRequest UpdatePet contentType NoContent MimeNoContent
updatePet _ body =
  _mkRequest "PUT" ["/pet"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthOAuthPetstoreAuth)
    `setBodyParam` body
...
updatePetWithForm 
  ...
  -> PetStoreRequest UpdatePetWithForm MimeFormUrlEncoded NoContent MimeNoContent
...
uploadFile 
  ...
  -> PetStoreRequest UploadFile MimeMultipartFormData ApiResponse MimeJSON
