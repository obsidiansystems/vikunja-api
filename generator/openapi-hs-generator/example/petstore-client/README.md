...
| baseModule                      | Set the base module namespace                                                                                                 |          | PetStore                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | petstore-client                    |
| cabalVersion                    | Set the cabal version number, consisting of a sequence of one or more integers separated by dots                              | 0.1.0.0  | 1.0.5                    |
| customTestInstanceModule        | test module used to provide typeclass instances for types not known by the generator                                          |          |         |
| configType                      | Set the name of the type used for configuration                                                                               |          | PetStoreConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | PetStoreRequest                     |
